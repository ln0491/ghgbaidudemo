 ...
 * 商业公司
 */
public class BusinessCompanyActivity2 extends BaseMapActivity implements MyClusterRendered {
...
//                        setZoom(zoom_city);
    ...
    private void initMap() {
        ...
        mClusterManager.setOnClusterItemClickListener(new ClusterManager.OnClusterItemClickListener<MyItem>() {
            ...
            public boolean onClusterItemClick(MyItem item,Marker marker) {
                ...
                if (type == Constants.Area.PROVINCE) {
                    ...
                    setMapCenter(new LatLng(Double.valueOf(businessCompany.latitude), Double.valueOf(businessCompany.longitude)),-1);
                    setBottomViewVisible(true, businessCompany);
                } else if (type == Constants.Area.CITY) {
                    Intent intent = new Intent(BusinessCompanyActivity2.this, BusinessCompanyDetailActivity.class);
        ...
        mClusterManager.setOnClusterClickListener(new ClusterManager.OnClusterClickListener<MyItem>() {
            ...
            public boolean onClusterClick(Cluster<MyItem> cluster) {
                ...
                setMapCenter(new LatLng(Double.valueOf(businessCompany.latitude), Double.valueOf(businessCompany.longitude)),zoom_provice);
                return true;
            }
        });
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_menu:
                startActivity(new Intent(BusinessCompanyActivity2.this, BusinessCompanyListActivity.class));
                break;
            case R.id.btn_back:
    ...
    private void addAllProvinceMark(List<BusinessCompany> companys, int type) {
        ...
        if (companys == null && companys.size() == 0) {
            Toast.makeText(BusinessCompanyActivity2.this, "无数据", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        mClusterManager.initBusinessCompanyData(mCountryCompany.quantity,mCountryCompany.factNum+"/"+mCountryCompany.planNum);
        addMarkers(items);
    ...
    private class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation bdLocation) {
            ...
            if (bdLocation == null) {
                isFirstLocation = false;
                Toast.makeText(BusinessCompanyActivity2.this, "定位失败", Toast.LENGTH_SHORT).show();
                return;
            }
            Toast.makeText(BusinessCompanyActivity2.this, bdLocation.getAddrStr(), Toast.LENGTH_SHORT).show();
    ...
    private void getAllProvince() {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                List<BusinessCompany> businessCompanies= Data.getResBusinessCompany(BusinessCompanyActivity2.this, Constants.Area.COUNTRY, null);
                mCountryCompany=businessCompanies.get(0);
                mAllProvince = Data.getResBusinessCompany(BusinessCompanyActivity2.this, Constants.Area.PROVINCE, null);
    ...
    private void getLowerCompanys(String province) {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                mLowerCompanys = Data.getResBusinessCompany(BusinessCompanyActivity2.this, Constants.Area.CITY, provinceStr);
