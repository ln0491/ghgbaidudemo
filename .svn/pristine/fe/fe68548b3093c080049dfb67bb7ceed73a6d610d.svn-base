...
import com.ghg.tobacco.fragment.BigDataBusinessCompanyFragment;
import com.ghg.tobacco.fragment.BigDataBusinessFragment;
...
public class BigDataActivity extends BaseActivity{
    ...
    private Class<? extends Fragment>[] mFragments = new Class[]{BigDataIndustryFragment.class, BigDataBusinessCompanyFragment.class, BigDataBusinessFragment.class,
    ...
    private void initViewPager() {
        ...
        mViewPager.setCurrentItem(0);
        mViewPager.setOffscreenPageLimit(fragmetns.size());
        setTabPostiion(0);
