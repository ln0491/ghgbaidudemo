package com.ghg.tobacco.custom_view.wheel;
...
import com.ghg.tobacco.custom_view.wheel.adapters.AbstractWheelTextAdapter;
import com.ghg.tobacco.custom_view.wheel.views.OnWheelChangedListener;
import com.ghg.tobacco.custom_view.wheel.views.OnWheelScrollListener;
import com.ghg.tobacco.custom_view.wheel.views.WheelView;
...
public class ChangeBirthDialog extends Dialog implements View.OnClickListener {
	...
	public ChangeBirthDialog(Context context,boolean isYear) {
