...
//    private RotationLayout mRotationLayout;
    ...
    private String real_plan="";//商业公司实际产量/计划产量
    private String industryPlan="";//工业公司计划产量
    private String businessCount="";//商戶數量
    ...
    public IconGenerator(Context context) {
        ...
        if (Constants.ClusterType.ACTIVITY_TYPE==Constants.ClusterType.INDUSTRY){
            mContainer = (ViewGroup) LayoutInflater.from(mContext).inflate(R.layout.industry_province_mark, null);
            mContentView = mTextView = (TextView) mContainer.findViewById(R.id.tv_province_account);
            tv_province = (TextView) mContainer.findViewById(R.id.tv_province);
        }else if (Constants.ClusterType.ACTIVITY_TYPE==Constants.ClusterType.BUSINESS_COMPANY){
            mContainer = (ViewGroup) LayoutInflater.from(mContext).inflate(R.layout.mark_business, null);
            mContentView = mTextView = (TextView) mContainer.findViewById(R.id.tv_plan);
            tv_province = (TextView) mContainer.findViewById(R.id.tv_province_nums);
        }else if (Constants.ClusterType.ACTIVITY_TYPE==Constants.ClusterType.BUSINESS){
            mContainer = (ViewGroup) LayoutInflater.from(mContext).inflate(R.layout.business_mark, null);
            mContentView = mTextView = (TextView) mContainer.findViewById(R.id.tv_business_account);
        }
...
//    }
        ...
        public View makeView(String text) {
            if (mTextView != null) {
                if (Constants.ClusterType.ACTIVITY_TYPE== Constants.ClusterType.INDUSTRY){
//                    if (Constants.ClusterType.CLUSTER_TYPE==Constants.Area.COUNTRY){
                        mTextView.setText(text+"家工业公司");
                        tv_province.setText("中国");
//                    }
                }else if (Constants.ClusterType.ACTIVITY_TYPE== Constants.ClusterType.BUSINESS_COMPANY){
                    tv_province.setText(proviceCount+"省");
//                    mTextView.setText("省级烟草专局");
                    mTextView.setText(real_plan);
                }else if (Constants.ClusterType.ACTIVITY_TYPE== Constants.ClusterType.BUSINESS){
                    mTextView.setText(businessCount);
                }
...
//        mRotationLayout.addView(contentView);
        mContentView = contentView;
         ...
         View view=null;
        if (Constants.ClusterType.ACTIVITY_TYPE==Constants.ClusterType.INDUSTRY){
            view = mContainer.findViewById(R.id.tv_province_account);
        }else if (Constants.ClusterType.ACTIVITY_TYPE==Constants.ClusterType.BUSINESS_COMPANY){
            view = mContainer.findViewById(R.id.tv_plan);
        }else{
            view = mContainer.findViewById(R.id.tv_business_account);
        }
...
//    }
    ...
    public void initBusinessCompanyData(int proviceCount , String real_plan){
        ...
        this.proviceCount=proviceCount;
    }
