...
public class ClusterManager<T extends ClusterItem> implements
    ...
    public ClusterManager(Context context, BaiduMap map,MyClusterRendered  myClusterRendered) {
        this(context, map, new MarkerManager(map),myClusterRendered);
        this.mContext=context;
    }

    public ClusterManager(Context context, BaiduMap map, MarkerManager markerManager,MyClusterRendered  myClusterRendered) {
        mMap = map;
        mMarkerManager = markerManager;
        mClusterMarkers = markerManager.newCollection();
        mMarkers = markerManager.newCollection();
        mRenderer = new DefaultClusterRenderer<T>(context, map, this,myClusterRendered);
...
//        return false;
    ...
    public void setlusterSize(int clusterSize){
        DefaultClusterRenderer defaultClusterRenderer= (DefaultClusterRenderer) mRenderer;
        defaultClusterRenderer.setlusterSize(clusterSize);
    }
    public void initBusinessCompanyData(int proviceCount , String real_plan){
        DefaultClusterRenderer defaultClusterRenderer= (DefaultClusterRenderer) mRenderer;
        defaultClusterRenderer.initBusinessCompanyData(proviceCount,real_plan);
    }
    public void initIndustryData( String industryPlan){
        DefaultClusterRenderer defaultClusterRenderer= (DefaultClusterRenderer) mRenderer;
        defaultClusterRenderer.initIndustryData(industryPlan);
    }
    public void initBusinessData( String businessCount){
        DefaultClusterRenderer defaultClusterRenderer= (DefaultClusterRenderer) mRenderer;
        defaultClusterRenderer.initBusinessData(businessCount);
    }
}
