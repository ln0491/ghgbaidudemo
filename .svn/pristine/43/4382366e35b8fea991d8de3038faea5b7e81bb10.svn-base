...
public final class ViewfinderView extends View {
	...
	public ViewfinderView(Context context, AttributeSet attrs) {
		...
		labelTextSize = array.getFloat(R.styleable.ViewfinderView_label_text_size, 46f);
...
//	}
	...
	private void drawTextInfo(Canvas canvas, Rect frame) {
		...
		canvas.drawText(labelText, frame.left + frame.width() / 2, frame.bottom +UnitUtils.dip2px(getContext(),40), paint);
	}
