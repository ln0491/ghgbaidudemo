...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
    ...
    public void setHighlight(Highlight[] highlights) {
    ...
    public boolean valuesToHighlight() {
        ...
        //            Log.d("vivi","valuesToHighlight==null");
        //        }else if (mIndicesToHighlight.length<=0){
        //            Log.d("vivi","mIndicesToHighlight.length<=0");
        //        }else {
        //            Log.d("vivi","mIndicesToHighlight[0]="+mIndicesToHighlight[0]);
        //        }
