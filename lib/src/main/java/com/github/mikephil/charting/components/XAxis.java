...
public class XAxis extends AxisBase {
    ...
    private boolean firstOffest=false;

    public  HashMap<Integer,String> maps;
    public float lastAnchorX=0;
     ...
     * labels
     */
    private int mSpaceBetweenLabels = 0;
...
//        mYOffset = Utils.convertDpToPixel(-10f); // -3
//        mXOffset=10;
//        mYOffset=20;
    }
    ...
    public void setFirstOffest(boolean firstOffest) {
        this.firstOffest = firstOffest;
    }
    public boolean getFirstOffest( ) {
        return firstOffest;
    }
