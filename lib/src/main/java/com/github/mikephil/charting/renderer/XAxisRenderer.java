...
public class XAxisRenderer extends AxisRenderer {
    ...
    public void computeAxis(float xValMaximumLength, List<String> xValues) {
        ...
        final float labelHeight = Utils.calcTextHeight_(mAxisLabelPaint, "月");
...
//                        float width=160;
    ...
    protected void drawLabel(Canvas c, String label, int xIndex, float x, float y, PointF anchor, float angleDegrees) {
        ...
        Log.d("vivi","mViewPortHandler.contentWidth()="+mViewPortHandler.contentWidth());
        float recfWidth=mViewPortHandler.contentWidth()/(mXAxis.getAxisMaximum()+1);
//        Utils.drawXAxisValue(c, formattedLabel, x, y, mAxisLabelPaint, anchor, angleDegrees,xIndex,selec);
        Utils.drawXAxisValue(c, formattedLabel, x, y, mAxisLabelPaint, anchor, angleDegrees,xIndex,mXAxis.getSelectedIndex(),mXAxis,recfWidth);
    ...
    public void renderLimitLineLabel(Canvas c, LimitLine limitLine, float[] position, float yOffset)
    {
        ...
        if (label != null && !label.equals("")) {
            ...
            if (labelPosition == LimitLine.LimitLabelPosition.RIGHT_TOP) {
                ...
                final float labelLineHeight = Utils.calcTextHeight_(mLimitLinePaint, "月");
